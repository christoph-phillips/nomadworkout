        ...
        process.nextTick(function() {
          ...
          User.findOne({ "local.email": email }, function(err, user) {
            ...
            if (user) {
              return done(
                null,
                false /*, req.flash('signupMessage', 'That username is already taken.')*/
              );
            } else {
      ...
      function(req, email, password, done) {
        ...
        User.findOne({ "local.email": email }, function(err, user) {
          ...
          if (!user)
            return done(
              null,
              false /*, req.flash('loginMessage', 'No user found.')*/
          ...
          if (!user.validPassword(password))
            return done(
              null,
              false /*, req.flash('loginMessage', 'Oops! Wrong password.')*/
